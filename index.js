...
function generatePortfolioDiv() {
  return `<div class="portfolio-div about-me">
            ...
            <h3>Quiz App</h3>
            <a href="https://thinkful-ei-narwhal.github.io/quiz-app-Max-Tyler/" alt="link to Quiz App" target="_blank"><img src="img/quiz.png" class="portfolio-pic" alt="screenshot of Quiz App" /></a>
            <p><i>HTML, CSS, jQuery</i></p>
            <p>This is a quiz-app that covers knowledge of Brazilian Jiu-Jitsu. Ideal audience is a beginner or hobbyist of BJJ. It was built as a basic project to learn jQuery in my bootcamp course. The user can submit answers and get a score at the end.</p>
            </div>`;
}
...
function generateContactDiv() {
  return `<div class="contact-div about-me">
            <h2>Contact</h2>
            <p><a href="https://github.com/Redact0r" alt="Github link" target="_blank"><b>Github</b></a></p>
            <p><a href="https://www.linkedin.com/in/tyler-sharp-1346a1a7/" alt="Linkedin link" target="_blank"><b>LinkedIn</b></a></p>
            <p><a href="mailto:johntylersharp@gmail.com" alt="Email link" target="_blank">Email</a></p>
            </div>`;
}
